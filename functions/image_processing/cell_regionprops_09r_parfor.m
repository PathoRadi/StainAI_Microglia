...
if exist(save_filename_temp,'file')
    ...
    if isempty(bn)~=1
        ...
        parfor bcp = bn
            ...
            if opt.FD==1 || opt.LC==1
                ...
                if opt.LC==1;
                    ...
                    LCstd(bcp,1)=fracL.Lacunarity_std;
                end
                if opt.FD==1;
        ...
        save(save_filename_temp,'bcp','CA','CP','CC','CHC','diameterBC','rMmCHr','meanCHrd','FD','LC','LCstd','FM_BREN_bbox1p2',...
